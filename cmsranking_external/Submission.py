...
from cmsranking_external.Entity import Entity, InvalidData
from cmsranking_external.Store import Store
from cmsranking_external.Subchange import store as subchange_store
...
class Submission(Entity):
    ...
    def consistent(self):
        from cmsranking_external.Task import store as task_store
        from cmsranking_external.User import store as user_store
